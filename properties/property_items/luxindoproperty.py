...
from properties.items import find_published_date, remove_tags, to_number, JoinAndStrip
from datetime import datetime


class LuxindoPropertyItem(scrapy.Item):
    ...
    list_date = scrapy.Field(
        input_processor=MapCompose(find_published_date),
